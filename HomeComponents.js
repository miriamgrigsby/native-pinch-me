...
export default class App extends Component {
    ...
    handleConnection = () => {
        axios.post('http://10.0.0.110:3030/bluetoothOn', {Grip: this.state.grip, WristPitch: this.state.wristPitch, WristRoll: this.state.wristRoll, Elbow: this.state.elbow, Shoulder: this.state.shoulder, Waist: this.state.waist})
    ...
    onAdd = () => {
        axios.post('http://10.0.0.110:3030/newBot', {NewBot: this.state.botName, Grip: this.state.grip, WristPitch: this.state.wristPitch, WristRoll: this.state.wristRoll, Elbow: this.state.elbow, Shoulder: this.state.shoulder, Waist: this.state.waist})
    }

    onSave = () => {
        axios.post('http://10.0.0.110:3030/onSave')
        this.setState({
            new: false,
        })
    }
    ...
    resetAll = () => {
        ...
        axios.get('http://10.0.0.110:3030/onReset')
    }
