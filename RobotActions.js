...
export default class RobotActions extends Component {
    ...
    componentDidMount() {
        axios.get('http://10.225.130.82:3030/findName')
        .then(response => this.setState({addedBots: response.data}))
    }

    showNewRobot = (name) => {
        axios.post('http://10.225.130.82:3030/showNewRobot', {Name: name})
    }
    ...
    deleteRobot = (name) => {
        ...
        axios.post('http://10.225.130.82:3030/deleteRobot', {Name: name})
    }
